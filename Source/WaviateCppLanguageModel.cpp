...
const std::vector<FunctionSymbol>& waviateCoreMemberFunctions()
{
    static const std::vector<FunctionSymbol> symbols {
        ...
        function("ADSR", "float", { param("float", "attack"), param("float", "decay"), param("float", "sustain"), param("float", "release"), param("float", "t") }, SymbolKind::Method, "ADSR envelope."),
        function("newArray", "WaviateArray<T>", { param("uint64_t", "size") }, SymbolKind::Method, "Allocate a temporary arena-backed array for the current shader pass."),
        function("newVector", "WaviateVector<T>", { param("uint64_t", "capacity", "0") }, SymbolKind::Method, "Allocate a temporary arena-backed vector for the current shader pass."),
        function("newString", "WaviateString", { param("uint64_t", "capacity", "0") }, SymbolKind::Method, "Allocate a temporary arena-backed string for the current shader pass."),
        function("newMap", "WaviateMap<K,V>", { param("uint64_t", "capacity", "0") }, SymbolKind::Method, "Allocate a temporary arena-backed map for the current shader pass."),
    };
...
const std::vector<FieldSymbol>& cppBuiltinTypes()
{
    static const std::vector<FieldSymbol> symbols {
        ...
        classSymbol("WaviateArray", "Temporary arena-backed array valid only for the current shader pass."),
        classSymbol("WaviateVector", "Temporary arena-backed vector valid only for the current shader pass."),
        classSymbol("WaviateString", "Temporary arena-backed string valid only for the current shader pass."),
        classSymbol("WaviateMap", "Temporary arena-backed map valid only for the current shader pass."),
        typeSymbol("void"),
        typeSymbol("auto"),
        typeSymbol("bool"),
        typeSymbol("char"),
