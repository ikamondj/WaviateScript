...
std::string CfileTemplateGenerator::getDefaultFileSource() const
{
...
// WaviateComplex frequency_process(const WaviateFrequencyInput* input, WaviateFrequencyStateWriter* writer) {
